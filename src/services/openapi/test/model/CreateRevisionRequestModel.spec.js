...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.CreateRevisionRequestModel();
  });
  ...
  describe('CreateRevisionRequestModel', function() {
    it('should create an instance of CreateRevisionRequestModel', function() {
      // uncomment below and update the code to test CreateRevisionRequestModel
      //var instance = new FastApi.CreateRevisionRequestModel();
      //expect(instance).to.be.a(FastApi.CreateRevisionRequestModel);
    });
