...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.ORMPoolResources();
  });
  ...
  describe('ORMPoolResources', function() {
    it('should create an instance of ORMPoolResources', function() {
      // uncomment below and update the code to test ORMPoolResources
      //var instance = new FastApi.ORMPoolResources();
      //expect(instance).to.be.a(FastApi.ORMPoolResources);
    });
