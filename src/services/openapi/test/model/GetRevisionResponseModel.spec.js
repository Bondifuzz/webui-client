...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.GetRevisionResponseModel();
  });
  ...
  describe('GetRevisionResponseModel', function() {
    it('should create an instance of GetRevisionResponseModel', function() {
      // uncomment below and update the code to test GetRevisionResponseModel
      //var instance = new FastApi.GetRevisionResponseModel();
      //expect(instance).to.be.a(FastApi.GetRevisionResponseModel);
    });
