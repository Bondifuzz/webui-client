...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.ApiGatewayAppApiUserUsersGetUserResponseModel();
  });
  ...
  describe('ApiGatewayAppApiUserUsersGetUserResponseModel', function() {
    it('should create an instance of ApiGatewayAppApiUserUsersGetUserResponseModel', function() {
      // uncomment below and update the code to test ApiGatewayAppApiUserUsersGetUserResponseModel
      //var instance = new FastApi.ApiGatewayAppApiUserUsersGetUserResponseModel();
      //expect(instance).to.be.a(FastApi.ApiGatewayAppApiUserUsersGetUserResponseModel);
    });
