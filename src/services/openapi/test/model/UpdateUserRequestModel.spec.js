...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.UpdateUserRequestModel();
  });
  ...
  describe('UpdateUserRequestModel', function() {
    it('should create an instance of UpdateUserRequestModel', function() {
      // uncomment below and update the code to test UpdateUserRequestModel
      //var instance = new FastApi.UpdateUserRequestModel();
      //expect(instance).to.be.a(FastApi.UpdateUserRequestModel);
    });
