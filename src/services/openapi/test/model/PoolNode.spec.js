...
(function(root, factory) {
  ...
  describe('PoolNode', function() {
    it('should create an instance of PoolNode', function() {
      // uncomment below and update the code to test PoolNode
      //var instance = new FastApi.PoolNode();
      //expect(instance).to.be.a(FastApi.PoolNode);
    });
