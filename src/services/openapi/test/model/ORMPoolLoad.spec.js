...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.ORMPoolLoad();
  });
  ...
  describe('ORMPoolLoad', function() {
    it('should create an instance of ORMPoolLoad', function() {
      // uncomment below and update the code to test ORMPoolLoad
      //var instance = new FastApi.ORMPoolLoad();
      //expect(instance).to.be.a(FastApi.ORMPoolLoad);
    });
