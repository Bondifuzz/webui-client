...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.UpdateRevisionResourcesRequestModel();
  });
  ...
  describe('UpdateRevisionResourcesRequestModel', function() {
    it('should create an instance of UpdateRevisionResourcesRequestModel', function() {
      // uncomment below and update the code to test UpdateRevisionResourcesRequestModel
      //var instance = new FastApi.UpdateRevisionResourcesRequestModel();
      //expect(instance).to.be.a(FastApi.UpdateRevisionResourcesRequestModel);
    });
